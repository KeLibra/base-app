package com.megvii.ocr.idcardlib;
...
import com.megvii.ocr.idcardlib.util.ICameraIdCard;
import com.megvii.ocr.idcardlib.util.RotaterUtil;
import com.megvii.ocr.idcardlib.util.Util;
import com.megvii.ocr.idcardlib.view.IDCardIndicator;
import com.megvii.ocr.idcardlib.view.IDCardNewIndicator;
...
public class IDCardScanActivity extends Activity implements TextureView.SurfaceTextureListener, Camera.PreviewCallback {
    ...
    private ICameraIdCard mICamera;// 照相机工具类
    ...
    private void init() {
        ...
        mICamera = new ICameraIdCard(mIsVertical);
    ...
    private void initData() {
        ...
        // 获取错误类型
        String errorType = idCardQualityAssessment.errorType;
        Log.e("====msg_face_TAG", "Type:" + errorType);
