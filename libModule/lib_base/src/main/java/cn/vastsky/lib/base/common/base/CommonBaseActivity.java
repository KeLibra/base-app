package cn.vastsky.lib.base.common.base;
...
import cn.vastsky.lib.base.common.view.defaultview.DefaultLoadingDialog;
...
import cn.vastsky.lib.base.common.view.impl.ILoadingDialog;
import cn.vastsky.lib.base.common.view.impl.ITitleView;
import cn.vastsky.lib.base.common.view.statusbar.ImmersionBar;
import cn.vastsky.lib.manager.AppActivityManager;
import cn.vastsky.lib.reten.ActivityConfig;
import cn.vastsky.lib.utils.EventBusUtils;
...
//        isRegisterEventBus = registerEventBus();
    ...
    // 默认不可关闭dialog
    public synchronized void showProgressDialog(final String loadingMsg) {
